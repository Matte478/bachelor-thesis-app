<template>
    <section class="section">
        ...
        >
            <form class="form" action="#" @submit.prevent="addType">
                <div class="form-group">
                    <label for="meal">Názov pracovného pomeru</label>
                    <div class="input-group">
                        <input type="text" name="name" id="name" class="input" v-model="newType.name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" step="0.01" name="contribution" id="contribution" class="input" v-model="newType.contribution">
                    </div>
                </div>

                <div class="form-group">
                    <obd-button type="submit" block>Pridať pracovný pomer</obd-button>
                </div>
            </form>
        </obd-modal>
        ...
        >
            <form class="form" action="#" @submit.prevent="editType">
                <div class="form-group">
                    <label for="meal">Názov jedla</label>
                    <div class="input-group">
                        <input type="text" name="name" id="name" class="input" v-model="editableType.name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" step="0.01" name="contribution" id="contribution" class="input" v-model="editableType.contribution">
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        loadTypeOfEmployments() {
            this.$store.dispatch('typeOfEmployments/fetchTypeOfEmployments')
            .then(() => {
                this.typeOfEmployments = this.$store.getters['typeOfEmployments/getTypeOfEmployments'];
        ...
        addType() {
            this.$store.dispatch('typeOfEmployments/submitTypeOfEmployment', this.newType)
            .then(() => {
                this.loadTypeOfEmployments();
                this.newType.name = '';
            ...
            .catch((e) => {
                this.flashError('Niečo sa pokazilo, nebolo možné pridať nový pracovný pomer.');
            });
        ...
        openEditPopup(typeId) {
            this.$store.dispatch('typeOfEmployments/fetchTypeOfEmployments', typeId)
            .then(() => {
                this.editableType = this.$store.getters['typeOfEmployments/getTypeOfEmployments'];
        ...
        editType(typeId) {
            this.$store.dispatch('typeOfEmployments/editTypeOfEmployment', this.editableType)
            .then(() => {
                this.loadTypeOfEmployments();
            ...
            .catch((e) => {
                this.flashError('Niečo sa pokazilo, nebolo možné upraviť pracovný pomer.');
            }); 
        ...
        deleteType(typeId) {
            ...
            if(response) {
                this.$store.dispatch('typeOfEmployments/deleteTypeOfEmployment', typeId)
                .then(() => {
                    let typeOfEmployments = this.typeOfEmployments.filter(type => type.id != typeId);
                ...
                .catch((e) => {
                    this.flashError('Niečo sa pokazilo, nebolo možné vymazať pracovný pomer.');
                }); 
            }
        }
    }
